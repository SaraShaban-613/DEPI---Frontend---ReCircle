...
function AwardCard({ title, date, description, progress, bg, iconColor, border, icon }) {
    return (
        <div
            className="award-card d-flex align-items-center rounded-4 p-3"
            style={{ border: "1px solid #3d5a40" }}
        >
            ...
            >
                ...
                <i className={`bi ${icon || "bi-award text-white"} fs-4 `}></i>
            </div>
            ...
            <div className="details flex-grow-1">
                ...
                {progress && (
                    <>
                        ...
                        <p className="text-end fw-semibold mb-0 mt-1 small">
                            {(progress / 100) * 50}/50
                        </p>
                    </>
                )}
