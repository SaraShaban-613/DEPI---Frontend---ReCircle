...
export default function Login() {
    ...
    async function ensureUserDocument(user, extraData = {}) {
        ...
        } else if (Object.keys(extraData).length) {
            await setDoc(ref, extraData, { merge: true });
        }
    ...
    return (
        <main className="container my-5">
            <div className="wrapper p-3">
                <div id="signup-box1" className="box" style={{ backgroundColor: "white" }}>
                    <h2 className="fw-bold mb-2 fs-1">ReCircle</h2>
                    <p>Turn Surplus into Support</p>

                    <button
                        id="sign-up-btn"
                        className="btn btn-outline-dark w-100 d-flex gap-2 justify-content-center align-content-center mt-1"
                        onClick={handleGoogleLogin}
                    >
