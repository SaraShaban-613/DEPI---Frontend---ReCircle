    ...
    return (
        <div style={{
            ...
            <button
                ...
                style={{ padding: "0.6rem 1.5rem", fontSize: "0.9rem", fontWeight: "500", border: "0.1rem solid #375840", borderRadius: "0.3rem", backgroundColor: "white", color: "#375840", cursor: "pointer" }}
            >
                Sign Out
            </button>
        </div>
